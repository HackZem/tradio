		...
		<DialogPortal data-slot='dialog-portal'>
			...
			<DialogPrimitive.Content
				...
				className={cn(
					...
					gap-4 rounded-[25px] border p-6 shadow-lg duration-200 sm:max-w-lg`,
					className,
				)}
				{...props}
			>
				...
				{showCloseButton && (
					<DialogPrimitive.Close
						...
						className="data-[state=open]:bg-accent
							data-[state=open]:text-muted-foreground hover:text-destructive
							absolute top-4 right-4 rounded-xs opacity-70
							transition-[opacity,color] hover:opacity-100 focus:outline-hidden
